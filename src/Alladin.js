...
import './index'
import img2 from '../src/images/databasethree.jpg'
const Alladin = () => {
    return (
        <>
            <div className="container-fluid">
                <div className="row falcon-background"  style = {{backgroundImage:`url(${img2})`,  backgroundColor:` #090b136b`,minWidth:`100vw`,minHeight:`88.5vh`,backgroundSize:`cover`,opacity:`1`}}>
...
<div className="w-50 d-none d-md-block"><p className="text-white fs-5 "> ALLADIN stars Anthony Mackie as Sam Wilson aka The Falcon, and Sebastian Stan as Bucky Barnes aka The Winter Soldier. The pair, who came together in the final moments of “Avengers: Endgame,” team up on a global adventure that tests their abilities—and their patience.</p></div>
